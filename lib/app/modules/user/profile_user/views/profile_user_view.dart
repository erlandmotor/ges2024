...
import 'package:ges2024/app/modules/user/profile_user/views/profile_edit_view.dart';
import 'package:ges2024/app/modules/user/profile_user/views/profile_password_view.dart';
            ...
            children: [
              ...
              Card(
                ...
                child: InkWell(
                  borderRadius: BorderRadius.circular(12),
                  onTap: () {
                    Get.to(() => const ProfilePasswordView());
                  },
                  child: const ListTile(
                    leading: Icon(
                      Icons.key,
